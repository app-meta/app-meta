<template>
    <n-card>
        ...
        的低代码应用开发平台，
        功能包含但不限于表单可视化设计、H5 小程序、SFC（单页面组件）、统计图表、问卷调查、后端服务部署、多源数据库管理、FaaS函数等
        。
        ...
        <n-descriptions class="mt-4" label-placement="left" bordered :column="3" title="开发环境依赖" size="small">
...
<script setup>
    import { ref } from 'vue'
    import { InfoCircle, Code } from "@vicons/fa"
